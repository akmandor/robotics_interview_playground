...
/*
Given a list of n+1 integers and these integers are in the range of 0 to n. There are no duplicates in list. 
...
{ 
    ...
    expected_result = 2;
    cout << ((search_missing(test_arr, 9) == expected_result) ? " PASS ": " FAIL ") << endl; 
