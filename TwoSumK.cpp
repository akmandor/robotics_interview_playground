...
Bonus: Can you do this in one pass? YESSSSS
*/
...
int main(){
  ...
  cout << (two_sum_k({10, 15, 3, 7}, 17) == expected_result ? "PASS": "FAIL") << endl;  

  cout << "Test Case 3: {10, 15, 3, 7} - 15 ";
  expected_result = false;
  cout << (two_sum_k({10, 15, 3, 7}, 15) == expected_result ? "PASS": "FAIL") << endl;  

  cout << "Test Case 4: {10, 15, 3, 7, 0} - 15 ";
  expected_result = true;
  cout << (two_sum_k({10, 15, 3, 7, 0}, 15) == expected_result ? "PASS": "FAIL") << endl;  

  cout << "Test Case 5: {10, 15, 3, 7, 5, 0} - 15  ";
  expected_result = true;
  cout << (two_sum_k({10, 15, 3, 7, 5, 0}, 15) == expected_result ? "PASS": "FAIL") << endl;  
}
